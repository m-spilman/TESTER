    ...
    return (
      <Wrapper>
        <BodyWrapper>
          ...
          <Explanation>
            <p>
              You are creating a check-out link that buyers will use to purcahse
              your item.
            </p>
          </Explanation>
              ...
              <form id="itemForm">
                <div className="form-group ">
                  ...
                  <small className="form-text text-muted">
                    Short and easy to understand. Does not need to match your
                    listing title.
                  </small>
                  ...
                  <small className="form-text text-muted">
                    You can always adjust your price later.
                  </small>
                  <input
                    type="text"
                    className="form-control"
